  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="margin-left: auto; margin-right: 10px;">
        <span style="display: none;" id="deleteCommentId"></span>
        <button class="btn btn-success" type="button" data-dismiss="modal">Không</button>
        <button class="btn btn-warning" type="button" data-dismiss="modal" onclick="removeComment(document.getElementById('deleteCommentId').innerHTML)">Có</button>
      </div>
    </div>
  </div>
</div>